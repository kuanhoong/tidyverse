...
2. `values_to` is the name of the variable in the new “tidy” data frame that will contain the values of the original data. Observe how we set `values_to` = `democracy_score`. In the resulting `dem_tidy` the column `democracy_score` contains the $1x9=9$ democracy scores as numeric values.
